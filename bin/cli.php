...
$application->add((new SendEmailsToBehindStudentsCommand())->setNewLogger($rootDir . "/data/logs/php/cli.log"));
$application->add((new SendTrainingEndingEmailsCommand())->setNewLogger($rootDir . "/data/logs/php/cli.log"));
